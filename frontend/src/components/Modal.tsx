...
export function Modal({
  ...
  return (
    <div role="dialog" aria-modal="true" className="fixed inset-0 z-30 grid place-items-center p-4">
      ...
      <div className="border-line relative z-[1] max-h-[min(86dvh,760px)] w-[min(100%,460px)] overflow-auto overscroll-contain rounded-[8px] border bg-[rgba(18,17,16,0.98)] p-5 shadow-[0_28px_80px_rgba(0,0,0,0.55)]">
