...
export function ProfileSheet({
  ...
  return (
    <aside className="fixed inset-0 z-20">
      ...
      <div className="border-line absolute bottom-0 left-1/2 max-h-[min(82vh,720px)] w-[min(100%,560px)] -translate-x-1/2 overflow-auto rounded-t-[8px] border bg-[rgba(18,17,16,0.98)] p-[10px_16px_calc(18px+env(safe-area-inset-bottom,0px))] shadow-[0_24px_72px_rgba(0,0,0,0.48)]">
